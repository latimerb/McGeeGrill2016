...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 5, 0);
 	...
 	ivoc_help("help ?1 leak /home/mizzou/McGeeGrill2016/components/mechanisms/x86_64/leak.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/McGeeGrill2016/components/mechanisms/modfiles/leak.mod";
static const char* nmodl_file_text = 
